package com.silverhand.gateway.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.silverhand.gateway.repository..*)
        || within(com.silverhand.gateway.service..*)
        || within(com.silverhand.gateway.web.rest..*)
        """
    )
